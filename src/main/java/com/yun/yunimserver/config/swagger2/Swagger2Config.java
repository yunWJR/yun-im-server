package com.yun.yunimserver.config.swagger2;
...
public class Swagger2Config {
    ...
    public Docket apiSw2() {
        ...
        accPar.name(GlobalConstant.Sys.DEVICE_TYPE_DTO).description("devicetype").modelRef(new ModelRef("string")).parameterType("header").required(false).build();
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 包路径
                .apis(RequestHandlerSelectors.basePackage("com.yun.yunimserver"))
