...
public enum FriendStatusType {
    ...
    public static final String des = "发送者状态:1-等待验证、2-已拒绝 3-已添加";

    private final Integer type;
    private final String name;

    private FriendStatusType(Integer type, String name) {
        this.type = type;

        this.name = name;
    }

    public static boolean isValidItem(FriendStatusType type) {
        if (type == null) {
            return false;
        }
    ...
    public static FriendStatusType getByCode(Integer code) {
        for (FriendStatusType item : values()) {
